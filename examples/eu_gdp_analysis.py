...
QUERY = (
    "Using the latest available GDP data for 2025, analyze each country within the EU economic zone. "
    "Highlight those that are increasing or decreasing at an anomalous rate. "
    "Specify and break down which industries are causing these shifts and investigate macroeconomic trends within each country that are contributing."
)
